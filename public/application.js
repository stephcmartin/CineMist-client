...
var makeMovie = function makeMovie(data) {
  return $.ajax({
...
var editMovie = function editMovie(data, movieId) {
  console.log(movieId);
  return $.ajax({
    url: config.apiOrigin + '/movies/' + movieId,
    method: 'PATCH',
...
var movies = __webpack_require__(17);
...
var signInFailure = function signInFailure() {
  $('#message').text('Error with your login, buddy!').then($('#change-password').hide()).then($('#sign-out').hide()).then($('#list-body').hide());
};
...
var signOutFailure = function signOutFailure() {
  $('#message').text('Error wtih signing out, buddy!').then($('#change-password').hide()).then($('#sign-out').hide());
};
...
var onMakeMovie = function onMakeMovie(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log('our make movie data is ', data)
  api.makeMovie(data).then(ui.makeMovieSuccess).catch(ui.makeMovieFailure);
};

var onGetMovies = function onGetMovies(event) {
  event.preventDefault();
  api.getMovies().then(ui.getMoviesSuccess).catch(ui.getMoviesFailure);
};

var onHideMovie = function onHideMovie(event) {
  event.preventDefault();
  ui.hideMovie();
};
...
var api = __webpack_require__(7);
var getFormFields = __webpack_require__(5);
var showMoviesTemplate = __webpack_require__(19);

var makeMovieSuccess = function makeMovieSuccess(data) {
  ...
  api.getMovies().then(getMoviesSuccess).catch(makeMovieFailure);
};
var makeMovieFailure = function makeMovieFailure() {
  // console.log('Add Movie failure')
  $('#message').text('You have failed to add a movie to your list');
};

var getMoviesSuccess = function getMoviesSuccess(data) {
  // $('#message').text('List of movies attained')
  var showMoviesHtml = showMoviesTemplate({ movies: data.movies });
  $('#list').empty();
...
var noMoviesCreated = function noMoviesCreated() {
...
var onDeleteMovie = function onDeleteMovie() {
  ...
  api.deleteMovie(movieId).then(deleteMovieSuccess).catch(deleteMovieFailure);
};

var deleteMovieSuccess = function deleteMovieSuccess(data) {
  $('#message').text('You have successfully deleted the movie on your to-watch list');
  api.getMovies().then(getMoviesSuccess).catch(makeMovieFailure);
};
...
var onEditMovie = function onEditMovie(event) {
  var data = getFormFields(this);
  event.preventDefault();
  var movieId = $(this).parent().data('id');
  // console.log('Edit movie data is ' + data)
  api.editMovie(data, movieId).then(editMovieSuccess).catch(editMovieFailure);
};

var editMovieSuccess = function editMovieSuccess(data) {
  $('#message').text('You have successfully edited your movie');
  $('.edit-movie').trigger('reset');
  api.getMovies().then(getMoviesSuccess).catch(makeMovieFailure);
};

var editMovieFailure = function editMovieFailure() {
...
module.exports = {
  makeMovieSuccess: makeMovieSuccess,
  makeMovieFailure: makeMovieFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul data-id=\""
    ...
    + "\">\n    <li> <strong>Title:<br></strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + " <br><strong>Director:<br></strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.director : stack1), depth0))
    + " <br> <strong>Summary:<br></strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.summary : stack1), depth0))
    + "<br><strong>Genre: </strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.genre : stack1), depth0))
    + " <strong>Runtime:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.runtime : stack1), depth0))
    + "<strong> Year Released: </strong>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.year_release : stack1), depth0))
    + "</li>\n    <li><button class=\"btn btn-info btn-sm delete-movie\">Delete</button></li>\n     <li><button class= \"edit-movie-button btn btn-info btn-sm\">Edit</button></li>\n     <form class=\"edit-movie form-inline\" id=\"edit-movie-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n     <fieldset>\n                   <input type=\"text\" name=\"movie[title]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\">\n                   <input type=\"text\" name=\"movie[director]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.director : stack1), depth0))
    + "\">\n                   <input type=\"text\" name=\"movie[summary]\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.summary : stack1), depth0))
    + "\">\n                   <input type=\"text\" name=\"movie[genre]\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.genre : stack1), depth0))
    + ">\n                   <input type=\"text\" name=\"movie[runtime]\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.runtime : stack1), depth0))
    + ">\n                   <input type=\"text\" name=\"movie[year_released]\" class=\"form-control\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.year_release : stack1), depth0))
    + ">\n                   <input type=\"submit\" name=\"submit\" class=\"btn btn-primary btn-sm\" value=\"save\" id=\"save\">\n    </fieldset>\n      </form>\n  </li>\n  </ul>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
